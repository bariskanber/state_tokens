...
cannot equal many slopes---so no late-fused linear head represents Eq.~\eqref{eq:expert} on any
non-degenerate game distribution; the trained model accordingly ignored the dial entirely
($k^*$ identical at every fed value). Early fusion (the dial as an
