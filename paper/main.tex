...
unprefixed inputs. Post-hoc conditions: the same selfish base with the anchored preference objective of B on sparse ($\approx$20\%) or dense (every game) pairs, 3 epochs. Three seeds (42--44).
